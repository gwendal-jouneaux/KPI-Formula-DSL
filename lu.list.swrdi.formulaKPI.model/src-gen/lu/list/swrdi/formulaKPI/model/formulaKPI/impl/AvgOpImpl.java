...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Avg Op</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * </p>
 * <ul>
 *   <li>{@link lu.list.swrdi.formulaKPI.model.formulaKPI.impl.AvgOpImpl#getList <em>List</em>}</li>
 * </ul>
 *
 * @generated
 */
public class AvgOpImpl extends MinimalEObjectImpl.Container implements AvgOp {
	/**
	...
	protected EClass eStaticClass() {
		return formulaKPIPackage.Literals.AVG_OP;
	}
	...
	public NotificationChain basicSetList(Expression newList, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
					formulaKPIPackage.AVG_OP__LIST, oldList, newList);
			if (msgs == null)
				msgs = notification;
			else
		...
		if (newList != list) {
			...
			if (list != null)
				msgs = ((InternalEObject) list).eInverseRemove(this,
						EOPPOSITE_FEATURE_BASE - formulaKPIPackage.AVG_OP__LIST, null, msgs);
			if (newList != null)
			...
			eNotify(new ENotificationImpl(this, Notification.SET, formulaKPIPackage.AVG_OP__LIST, newList, newList));
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
		case formulaKPIPackage.AVG_OP__LIST:

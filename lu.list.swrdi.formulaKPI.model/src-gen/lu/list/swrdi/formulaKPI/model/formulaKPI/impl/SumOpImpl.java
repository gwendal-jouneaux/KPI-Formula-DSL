...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Sum Op</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * </p>
 * <ul>
 *   <li>{@link lu.list.swrdi.formulaKPI.model.formulaKPI.impl.SumOpImpl#getList <em>List</em>}</li>
 * </ul>
 *
 * @generated
 */
public class SumOpImpl extends MinimalEObjectImpl.Container implements SumOp {
	/**
	...
	protected EClass eStaticClass() {
		return formulaKPIPackage.Literals.SUM_OP;
	}
	...
	public NotificationChain basicSetList(Expression newList, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
					formulaKPIPackage.SUM_OP__LIST, oldList, newList);
			if (msgs == null)
				msgs = notification;
			else
		...
		if (newList != list) {
			...
			if (list != null)
				msgs = ((InternalEObject) list).eInverseRemove(this,
						EOPPOSITE_FEATURE_BASE - formulaKPIPackage.SUM_OP__LIST, null, msgs);
			if (newList != null)
			...
			eNotify(new ENotificationImpl(this, Notification.SET, formulaKPIPackage.SUM_OP__LIST, newList, newList));
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
		case formulaKPIPackage.SUM_OP__LIST:

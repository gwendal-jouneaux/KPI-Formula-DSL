 ...
 * </p>
 * <ul>
 *   <li>{@link lu.list.swrdi.formulaKPI.model.formulaKPI.impl.EnumerationLiteralImpl#getName <em>Name</em>}</li>
 * </ul>
 *
 * @generated
 */
public class EnumerationLiteralImpl extends MinimalEObjectImpl.Container implements EnumerationLiteral {
	...
	protected EClass eStaticClass() {
		return formulaKPIPackage.Literals.ENUMERATION_LITERAL;
	}
	...
	public void setName(String newName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, formulaKPIPackage.ENUMERATION_LITERAL__NAME, oldName,
					name));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
		case formulaKPIPackage.ENUMERATION_LITERAL__NAME:
			return getName();
		}

 ...
 * </p>
 * <ul>
 *   <li>{@link lu.list.swrdi.formulaKPI.model.formulaKPI.impl.ListLiteralImpl#getElements <em>Elements</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ListLiteralImpl extends MinimalEObjectImpl.Container implements ListLiteral {
	/**
	...
	protected EClass eStaticClass() {
		return formulaKPIPackage.Literals.LIST_LITERAL;
	}
	...
	public EList<Expression> getElements() {
		if (elements == null) {
			elements = new EObjectContainmentEList<Expression>(Expression.class, this,
					formulaKPIPackage.LIST_LITERAL__ELEMENTS);
		}
		return elements;
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
		case formulaKPIPackage.LIST_LITERAL__ELEMENTS:

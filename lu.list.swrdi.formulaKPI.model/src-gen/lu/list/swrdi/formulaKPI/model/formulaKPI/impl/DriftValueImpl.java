...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Drift Value</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * </p>
 * <ul>
 *   <li>{@link lu.list.swrdi.formulaKPI.model.formulaKPI.impl.DriftValueImpl#getWindow <em>Window</em>}</li>
 *   <li>{@link lu.list.swrdi.formulaKPI.model.formulaKPI.impl.DriftValueImpl#getWindowUnit <em>Window Unit</em>}</li>
 *   <li>{@link lu.list.swrdi.formulaKPI.model.formulaKPI.impl.DriftValueImpl#getOperation <em>Operation</em>}</li>
 * </ul>
 *
 * @generated
 */
public class DriftValueImpl extends MinimalEObjectImpl.Container implements DriftValue {
	/**
	...
	protected EClass eStaticClass() {
		return formulaKPIPackage.Literals.DRIFT_VALUE;
	}
	...
	public void setWindow(int newWindow) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, formulaKPIPackage.DRIFT_VALUE__WINDOW, oldWindow,
					window));
	}
	...
	public void setWindowUnit(WindowUnit newWindowUnit) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, formulaKPIPackage.DRIFT_VALUE__WINDOW_UNIT,
	...
	public NotificationChain basicSetOperation(Operation newOperation, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
					formulaKPIPackage.DRIFT_VALUE__OPERATION, oldOperation, newOperation);
			if (msgs == null)
				msgs = notification;
			else
		...
		if (newOperation != operation) {
			...
			if (operation != null)
				msgs = ((InternalEObject) operation).eInverseRemove(this,
						EOPPOSITE_FEATURE_BASE - formulaKPIPackage.DRIFT_VALUE__OPERATION, null, msgs);
			...
			eNotify(new ENotificationImpl(this, Notification.SET, formulaKPIPackage.DRIFT_VALUE__OPERATION,
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
		case formulaKPIPackage.DRIFT_VALUE__OPERATION:
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
		case formulaKPIPackage.DRIFT_VALUE__WINDOW:
			return getWindow();
		case formulaKPIPackage.DRIFT_VALUE__WINDOW_UNIT:

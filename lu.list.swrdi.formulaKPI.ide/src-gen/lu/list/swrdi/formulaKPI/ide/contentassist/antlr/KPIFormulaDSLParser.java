...
public class KPIFormulaDSLParser extends AbstractContentAssistParser {
	...
	public static final class NameMappings {
		...
		private static void init(ImmutableMap.Builder<AbstractElement, String> builder, KPIFormulaDSLGrammarAccess grammarAccess) {
			builder.put(grammarAccess.getComputationAccess().getFormulaAlternatives_2_0(), "rule__Computation__FormulaAlternatives_2_0");
			...
			builder.put(grammarAccess.getKPIFormulaDSLAccess().getGroup(), "rule__KPIFormulaDSL__Group__0");
			...
			builder.put(grammarAccess.getPrimaryAccess().getGroup_3_4(), "rule__Primary__Group_3_4__0");
			builder.put(grammarAccess.getPrimaryAccess().getGroup_4(), "rule__Primary__Group_4__0");
			builder.put(grammarAccess.getPrimaryAccess().getGroup_4_6(), "rule__Primary__Group_4_6__0");
			builder.put(grammarAccess.getPrimaryAccess().getGroup_5(), "rule__Primary__Group_5__0");
			builder.put(grammarAccess.getPrimaryAccess().getGroup_5_4(), "rule__Primary__Group_5_4__0");
			builder.put(grammarAccess.getPrimaryAccess().getGroup_6(), "rule__Primary__Group_6__0");
			builder.put(grammarAccess.getPrimaryAccess().getGroup_6_4(), "rule__Primary__Group_6_4__0");
			...
			builder.put(grammarAccess.getConditionAccess().getConditionsAssignment_1_0(), "rule__Condition__ConditionsAssignment_1_0");
			builder.put(grammarAccess.getConditionAccess().getResultsAssignment_1_2(), "rule__Condition__ResultsAssignment_1_2");
			builder.put(grammarAccess.getConditionAccess().getResultsAssignment_4(), "rule__Condition__ResultsAssignment_4");
			...
			builder.put(grammarAccess.getPrimaryAccess().getExpressionsAssignment_3_3(), "rule__Primary__ExpressionsAssignment_3_3");
			builder.put(grammarAccess.getPrimaryAccess().getExpressionsAssignment_3_4_1(), "rule__Primary__ExpressionsAssignment_3_4_1");
			builder.put(grammarAccess.getPrimaryAccess().getExpressionsAssignment_4_3(), "rule__Primary__ExpressionsAssignment_4_3");
			builder.put(grammarAccess.getPrimaryAccess().getWeightsAssignment_4_5(), "rule__Primary__WeightsAssignment_4_5");
			builder.put(grammarAccess.getPrimaryAccess().getExpressionsAssignment_4_6_1(), "rule__Primary__ExpressionsAssignment_4_6_1");
			builder.put(grammarAccess.getPrimaryAccess().getWeightsAssignment_4_6_3(), "rule__Primary__WeightsAssignment_4_6_3");
			builder.put(grammarAccess.getPrimaryAccess().getExpressionsAssignment_5_3(), "rule__Primary__ExpressionsAssignment_5_3");
			builder.put(grammarAccess.getPrimaryAccess().getExpressionsAssignment_5_4_1(), "rule__Primary__ExpressionsAssignment_5_4_1");
			builder.put(grammarAccess.getPrimaryAccess().getExpressionsAssignment_6_3(), "rule__Primary__ExpressionsAssignment_6_3");
			builder.put(grammarAccess.getPrimaryAccess().getExpressionsAssignment_6_4_1(), "rule__Primary__ExpressionsAssignment_6_4_1");
			builder.put(grammarAccess.getPrimaryAccess().getExpressionAssignment_7_3(), "rule__Primary__ExpressionAssignment_7_3");
			builder.put(grammarAccess.getPrimaryAccess().getThresholdAssignment_7_5(), "rule__Primary__ThresholdAssignment_7_5");
			...
			builder.put(grammarAccess.getAtomicAccess().getUnitAssignment_4_2(), "rule__Atomic__UnitAssignment_4_2");
			builder.put(grammarAccess.getAtomicAccess().getLiteralAssignment_5_1(), "rule__Atomic__LiteralAssignment_5_1");
			builder.put(grammarAccess.getAtomicAccess().getComputableAssignment_6_1(), "rule__Atomic__ComputableAssignment_6_1");
		}
	}
